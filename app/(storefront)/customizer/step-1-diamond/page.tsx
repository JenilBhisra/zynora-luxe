    ...
    return (
        <div className="animate-in fade-in duration-700 text-white">
            <AnimatedSection className="text-center mb-6 block md:hidden">
                <h2 className="text-xl font-medium text-white mb-2">Choose Your Diamond</h2>
                <p className="text-sm text-white/60 font-normal max-w-[560px] mx-auto">Select the perfect center stone to begin your custom ring journey.</p>
            </AnimatedSection>
