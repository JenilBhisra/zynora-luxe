        ...
        return (
            <div className="bg-[#FAFAF8] min-h-[80vh] flex items-center justify-center p-6">
                <div className="text-center max-w-lg">
                    ...
                    <Button onClick={() => router.push("/customizer/step-1-diamond")}>Start Customizing</Button>
                </div>
            </div>
        );
    }
            ...
            <div className="container-custom max-w-4xl">
                ...
                <FadeIn delay={0.3}>
                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                        ...
                        <Button fullWidth variant="outline" onClick={() => router.push("/customizer/step-1-diamond")} className="text-sm">
