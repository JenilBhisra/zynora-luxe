...
export default function AboutPage() {
    return (
        <div className="flex flex-col w-full bg-champagne-bg font-body text-champagne-text selection:bg-champagne-accent/30">
