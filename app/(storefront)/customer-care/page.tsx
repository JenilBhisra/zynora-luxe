...
export default function CustomerCarePage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F4] text-[#1A1A1A] py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-gradient-to-b from-[#C9A14A]/3 to-transparent rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-10 left-0 w-[35vw] h-[35vw] bg-gradient-to-t from-[#C9A14A]/3 to-transparent rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="container-custom relative z-10 px-4">
        ...
        >
          <span className="text-[11px] uppercase tracking-[0.3em] text-[#C9A14A] font-semibold">Zynora Care</span>
          <h1 className="text-4xl md:text-5xl font-heading font-light tracking-wide mt-3 mb-6 text-[#1A1A1A] leading-tight">
            Customer Care & <span className="font-serif italic text-[#C9A14A]">Bespoke Requests</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 md:mb-24">
          {[
            ...
            <motion.div
              ...
              className="bg-white border border-[#EAEAEA] rounded-2xl p-6 md:p-8 hover:border-[#C9A14A]/30 transition-all duration-500 group flex gap-5 items-start shadow-[0_4px_20px_rgba(0,0,0,0.02)]"
            >
              <div className="bg-[#C9A14A]/10 p-3 rounded-xl text-[#C9A14A] group-hover:scale-110 transition-transform duration-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-20 md:mb-28">
          ...
          >
            <div className="bg-white border border-[#EAEAEA] rounded-3xl p-8 shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative overflow-hidden">
              <h2 className="text-2xl font-heading text-[#1A1A1A] tracking-wide mb-6">Contact Channels</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="text-xs uppercase tracking-widest text-[#C9A14A] font-semibold mb-1">Call / WhatsApp</h4>
                    <p className="text-[#666666] text-xs mb-2">Speak directly with our designers:</p>
                    <div className="flex flex-col gap-1.5">
                      <a href="tel:+919724627122" className="text-[#1A1A1A] text-base font-medium hover:text-[#C9A14A] transition-colors flex items-center gap-2">
                        +91 97246 27122
                      </a>
                      <a href="tel:+919427143105" className="text-[#1A1A1A] text-base font-medium hover:text-[#C9A14A] transition-colors flex items-center gap-2">
                        +91 94271 43105
                      </a>
                    </div>
                  </div>
                ...
                <div className="flex gap-4 items-start border-t border-[#EAEAEA] pt-6">
                  ...
                  <div>
                    <h4 className="text-xs uppercase tracking-widest text-[#C9A14A] font-semibold mb-1">Official Support Email</h4>
                    <p className="text-[#666666] text-xs mb-2">For design portfolios & high-res assets:</p>
                    <a href="mailto:luxezynora@gmail.com" className="text-[#1A1A1A] text-base font-medium hover:text-[#C9A14A] transition-colors">
            ...
            {/* Premium Note */}
            <div className="bg-gradient-to-r from-[#C9A14A]/5 to-transparent border-l-2 border-[#C9A14A] p-6 rounded-r-2xl">
              <h4 className="text-[#1A1A1A] font-semibold text-sm mb-1.5">No Customization is Too Small</h4>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="lg:col-span-7 bg-white border border-[#EAEAEA] rounded-3xl p-8 shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative"
          >
            <h2 className="text-2xl font-heading text-[#1A1A1A] tracking-wide mb-2">Send Customization Request</h2>
            <p className="text-[#666666] text-xs mb-8">Fill out the details below and we will contact you within 24 hours.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              {submitStatus === "success" && (
                <motion.div
                  ...
                  className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 p-4 rounded-xl flex gap-3 items-center"
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-500">Our Zynora Luxe designers will review your specs and email you soon.</p>
                  </div>
                </motion.div>
              )}
              ...
              {submitStatus === "error" && (
                <motion.div
                  initial={{ scale: 0.9, opacity: 0 }}
                  animate={{ scale: 1, opacity: 1 }}
                  className="bg-red-500/10 border border-red-500/30 text-red-500 p-4 rounded-xl flex gap-3 items-center"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-[#C9A14A] font-semibold mb-2">Your Name *</label>
                  <input
                    type="text"
                    name="name"
                    required
                ...
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-[#C9A14A] font-semibold mb-2">Email Address *</label>
                  <input
                    type="email"
                    name="email"
                    required
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-[#C9A14A] font-semibold mb-2">Phone Number</label>
                  <input
                    type="tel"
                    name="phone"
                ...
                <div>
                  <label className="block text-[10px] uppercase tracking-widest text-[#C9A14A] font-semibold mb-2">Customization Type</label>
                  <select
                    name="subject"
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-widest text-[#C9A14A] font-semibold mb-2">Your Vision & Details *</label>
                <textarea
                  name="message"
                  required
                  rows={4}
                  ...
                  className="w-full bg-white border border-[#EAEAEA] focus:border-[#C9A14A] focus:outline-none text-sm text-[#1A1A1A] px-4 py-3 rounded-xl transition-colors placeholder-zinc-400 resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full flex justify-center items-center gap-2 py-4 bg-gradient-to-r from-[#C9A14A] to-[#B58F3B] hover:from-[#B58F3B] hover:to-[#C9A14A] text-white font-semibold rounded-xl transition-all duration-500 tracking-wider text-xs uppercase disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
        ...
        <div className="max-w-4xl mx-auto border-t border-[#EAEAEA] pt-16 md:pt-24">
          <h2 className="text-3xl font-heading text-center text-[#1A1A1A] tracking-wide mb-12">
            Frequently Asked <span className="font-serif italic text-[#C9A14A]">Questions</span>
          </h2>
          ...
          <div className="space-y-4">
            {FAQ_ITEMS.map((faq, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white border border-[#EAEAEA] rounded-2xl overflow-hidden transition-all duration-300 shadow-[0_4px_12px_rgba(0,0,0,0.01)]"
                >
                  <button
                    onClick={() => toggleFaq(index)}
                    className="w-full flex justify-between items-center p-6 text-left focus:outline-none group"
                  >
                    <span className="text-sm md:text-base font-medium text-[#1A1A1A] group-hover:text-[#C9A14A] transition-colors duration-300 pr-4">
                      {faq.question}
                    </span>
                    <motion.div
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      <motion.div
                        ...
                        transition={{ duration: 0.3 }}
                      >
                        <div className="p-6 pt-0 text-[#666666] text-xs md:text-sm leading-relaxed border-t border-[#EAEAEA]">
                          {faq.answer}
                        </div>
                      </motion.div>
                    )}
