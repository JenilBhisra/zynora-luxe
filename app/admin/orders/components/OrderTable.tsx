...
export function OrderTable({ initialOrders }: { initialOrders: any[] }) {
    ...
    return (
        <div className="relative">
            ...
            {selectedOrder && (
                <>
                    <div className="fixed inset-0 bg-gray-50/60 backdrop-blur-sm z-[9998] transition-opacity animate-in fade-in" onClick={() => setSelectedOrder(null)} />
                    <div className="fixed inset-y-0 right-0 w-full max-w-md bg-white  shadow-[-10px_0_30px_rgba(0,0,0,0.5)] z-[9999] transform transition-transform duration-300 flex flex-col border-l border-gray-200 animate-in slide-in-from-right">
                        ...
                        <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
                            ...
                            <div>
                                ...
                                <div className="space-y-3 mt-3">
                                    ...
                                    {(selectedOrder.razorpayId || selectedOrder.razorpayPaymentId) && (
                                        <div className="mt-5 pt-4 border-t border-gray-100 border-dashed text-xs space-y-2 text-gray-700">
                                            ...
                                            <div className="flex justify-between">
                                                ...
                                                <span className="font-mono text-[11px] text-gray-500">
                                                    {selectedOrder.razorpayPaymentId || selectedOrder.razorpayId}
                                                </span>
                                            </div>
                                            {selectedOrder.paymentStatus && (
                                                <div className="flex justify-between">
                                                    <span>Payment Status:</span>
                                                    <span className={`font-bold uppercase tracking-wider text-[10px] ${selectedOrder.paymentStatus === 'SUCCESS' ? 'text-green-600' : 'text-amber-600'}`}>
                                                        {selectedOrder.paymentStatus}
                                                    </span>
                                                </div>
                                            )}
